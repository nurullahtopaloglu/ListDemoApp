...
class DataSource {
    ...
    private object Constants {
        val peopleCountRange: ClosedRange<Int> = 200..300 // lower bound must be > 0, upper bound must be > lower bound
        ...
        const val backendBugTriggerProbability = 0.1 // must be > 0.0
